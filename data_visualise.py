...
class data_:
	...
	def convert_category_Onehot(self,df,cat_col):

		encoded_dataframe = pd.get_dummies(df, columns = cat_col)
		return encoded_dataframe,"One-Hot Encoder()"
